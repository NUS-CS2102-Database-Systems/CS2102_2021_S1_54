...
export const pet_owner_edit_personal_info =
  domain + "pet-owners/edit-personal-information?";

export const pet_owner_add_credit_card_info =
  domain + "pet-owners/add-credit-card-information?";

export const pet_owner_edit_credit_card_info =
  domain + "pet-owners/edit-credit-card-information?";

export const pet_owner_edit_pet_info =
  domain + "pet-owners/edit-pet-information?";
...
export const pet_owner_view_upcoming_jobs =
  domain + "pet-owners/view-upcoming-jobs?" + document.cookie;
...
export const full_time_caretaker_view_leaves =
  domain + "full-time-caretakers/view-leaves?" + document.cookie;
