          ...
          .then((response) => {
            if (
              ...
              Swal.fire({
                ...
                title: "Oops...",
                text:
                  "Credit card details could not be updated because it is used by another pet owner. If you suspect that someone is using your card fraudulently, please notify the bank and the police immediately. Otherwise, please use another credit card.",
              });
            }
          });
      }
